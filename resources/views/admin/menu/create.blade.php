...
@section('content')
  <div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Menu Baru</h1>
    <p class="text-sm text-gray-500 dark:text-gray-400">Tambahkan produk baru ke dalam katalog restoran Anda.</p>
  </div>
