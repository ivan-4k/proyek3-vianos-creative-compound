...
<!-- CSS untuk Swiper dengan navigasi Font Awesome -->
<style>
  /* Container Swiper */
  .swiper {
    position: relative;
  ...
  /* Navigasi Buttons dengan Font Awesome - Tampil di semua device */
  .swiper-nav-btn {
    position: absolute;
    top: 40%;
  ...
  /* Responsive: posisi tombol di tablet/desktop */
